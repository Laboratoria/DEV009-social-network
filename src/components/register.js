...
function register(navigateTo) {
  ...
  validarCampo(inputLastName, expresiones.apellido, divGroupLastName, iconLastName, errorMessageLastName );
  ...
  // validarCampo(inputPassword, expresiones.contraseña, divGroupPassword, iconPassword, errorMessagePassword);

  inputPassword.addEventListener('focusout', (e) => {
    if (expresion.contraseña.test(e.target.value)) {
  ...
  errorMessageConfirmPassword.textContent += "Longitud entre 6 - 10 caracteres, y contener números y algún carácter especial";

  divInputConfirmPassword.append(inputConfirmPassword, iconConfirmPassword);
  divGroupConfirmPassword.append(labelConfirmPassword, divInputConfirmPassword, errorMessageConfirmPassword);

  validarCampo(inputConfirmPassword, expresiones.confirmacionContraseña, divGroupConfirmPassword, iconConfirmPassword, errorMessageConfirmPassword);
  ...
  buttonCreateAccount.classList.add('formulario__grupo-btn-enviar');
